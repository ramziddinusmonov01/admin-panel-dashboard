                    ...
                    <table class="min-w-max w-full table-auto">
                        ...
                        <tbody class="text-gray-600 text-sm font-light">
                            ...
                            <tr class="hover:bg-gray-100 dark:hover:bg-gray-500">
                                <td class="py-3 px-6 text-left">
                                    <div class="flex items-center">
                                        <span class="text-base font-medium">Joylashuv uz</span>
                                    </div>
                                </td>
                                ...
                                <td class="py-3 px-6 text-center">
                                    <div class="flex items-center justify-center">
                                        ...
                                        <!-- edit -->
                                        <Modal :activeModal="activeModal" @open="changeActive" @close="closeModal"
                                            @submit="submitEdit()" :isImage="true" title="Tahrirlash"
                                            subtitle="Joylashuvni tahrirlash" btnTextSubmit="Saqlash">
                                            <template v-slot:body>
                                        ...
                                        <!-- delete -->
                                        <Modal :activeModal="activeModal" @open="changeActive" @close="closeModal"
                                            @submit="submitDelete" :isImage="true" title="O'chirish"
                            ...
                            <tr class="hover:bg-gray-100 dark:hover:bg-gray-500">
                                ...
                                <td class="py-3 px-6 text-center">
                                    <button class="bg-red-200 text-red-700 py-1 px-4 rounded-full text-xs">
                                        Nofaol
                                    </button>
                                </td>
                                <td class="py-3 px-6 text-center">
                                        ...
                                        <Modal :activeModal="activeModal" @open="changeActive" @close="closeModal"
                                            ...
                                            <template v-slot:body>
                                                <div class="flex justify-start gap-12">
                                                    ...
                                                    <div class="flex flex-col items-start gap-6">
                                                        <span class="font-normal text-base flex-1">09:00</span>
                                                        <span class="font-normal text-base flex-1">22:00</span>
                            ...
                            <tr class="hover:bg-gray-100 dark:hover:bg-gray-500">
                                <td class="py-3 px-6 text-left">
                                    <div class="flex items-center">
                                        <span class="text-base font-medium">Avtor</span>
                                    </div>
                                </td>
                                <td class="py-3 px-6 text-center">
                                    <button class="bg-red-200 text-red-700 py-1 px-4 rounded-full text-xs">
                                        ...
                                        <Modal :activeModal="activeModal" @open="changeActive" @close="closeModal"
                                            ...
                                            <template v-slot:body>
                                                <div class="flex justify-start gap-12">
                                                    ...
                                                    <div class="flex flex-col items-start gap-6">
                                                        <span class="font-normal text-base flex-1">iSoft</span>
                                                    </div>
                                                </div>
                                            </template>
                                            <template v-slot:button>
                                        ...
                                        <Modal :activeModal="activeModal" @open="changeActive" @close="closeModal"
                                            ...
                                            <template v-slot:body>
                                                <div class="flex justify-start gap-12">
                                                    ...
                                                    <div class="flex flex-col items-start gap-6">
                                                        <span class="font-normal text-base flex-1">Iteach</span>
                                                    </div>
                                                </div>
                                            </template>
                                            <template v-slot:button>

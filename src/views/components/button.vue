<template>
  ...
  <div class="button h-auto p-3">
      ...
      <ol class="inline-flex items-center space-x-1 md:space-x-3">
        ...
        <li>
          <div class="flex items-center">
            ...
            <a href="#"
              class="ml-1 text-sm font-medium text-gray-700 hover:text-gray-900 md:ml-2 dark:text-gray-400 dark:hover:text-white">Components</a>
          </div>
        </li>
        <li>
          <div class="flex items-center">
            ...
            <a href="#"
              class="ml-1 text-sm font-medium text-gray-700 hover:text-gray-900 md:ml-2 dark:text-gray-400 dark:hover:text-white">Button</a>
          </div>
        </li>
      </ol>
    </nav>
    ...
    <div class="grid grid-cols-2 gap-2 mt-5 font-lexend">
      <div class="card bg-white dark:bg-gray-800 w-full rounded-md p-5 border dark:border-gray-700 bpx">
        <!-- Button Default -->
      ...
      <div class="card bg-white dark:bg-gray-800 w-full rounded-md p-5 border dark:border-gray-700 bpx">
        ...
        <div class="wrapper-button w-full box-border mt-4">
          <button type="button"
            class="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 border-1 dark:border-gray-700-lg border-1 dark:border-gray-700-blue-500/50 dark:border-1 dark:border-gray-700-lg dark:border dark:border-gray-700-blue-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">
            Blue
          </button>
          <button type="button"
            class="text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 border-1 dark:border-gray-700-lg border-1 dark:border-gray-700-green-500/50 dark:border-1 dark:border-gray-700-lg dark:border dark:border-gray-700-green-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">
            Green
          </button>
          <button type="button"
            class="text-white bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 border dark:border-gray-700-lg border-1 dark:border-gray-700-cyan-500/50 dark:border-1 dark:border-gray-700-lg dark:border dark:border-gray-700-cyan-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">
            Cyan
          </button>
          <button type="button"
            class="text-white bg-gradient-to-r from-teal-400 via-teal-500 to-teal-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-teal-300 dark:focus:ring-teal-800 border-1 dark:border-gray-700-lg border-1 dark:border-gray-700-teal-500/50 dark:border-1 dark:border-gray-700-lg dark:border dark:border-gray-700-teal-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">
            Teal
          </button>
          <button type="button"
            class="text-gray-900 bg-gradient-to-r from-lime-200 via-lime-400 to-lime-500 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-lime-300 dark:focus:ring-lime-800 border-1 dark:border-gray-700-lg -1 dark:border-gray-700-lime-500/50 dark:border-1 dark:border-gray-700-lg dark:border-1 dark:border-gray-700-lime-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">
            Lime-1
          </button>
          <button type="button"
            class="text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 border-1 dark:border-gray-700-lg border-1 dark:border-gray-700-red-500/50 dark:border-1 dark:border-gray-700-lg dark:border-1 dark:border-gray-700-red-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">
            Red
          </button>
          <button type="button"
            class="text-white bg-gradient-to-r from-pink-400 via-pink-500 to-pink-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-pink-300 dark:focus:ring-pink-800 border-1 dark:border-gray-700-lg border-1 dark:border-gray-700-pink-500/50 dark:border-1 dark:border-gray-700-lg dark:border-1 dark:border-gray-700-pink-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">
            Pink
          </button>
          <button type="button"
            class="text-white bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-purple-300 dark:focus:ring-purple-800 border-1 dark:border-gray-700-lg border dark:border-gray-700-purple-500/50 dark:border-1 dark:border-gray-700-lg dark:border-1 dark:border-gray-700-purple-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">
            Purple
          </button>
        </div>
      </div>
      ...
      <div class="card bg-white dark:bg-gray-800 w-full rounded-md p-5 border dark:border-gray-700 bpx">
        ...
        <div class="wrapper-button w-full box-border mt-4">
          ...
          <button type="button"
            ...
            <svg class="w-4 h-4 mr-2 -ml-1" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="twitter"
      ...
      <div class="card bg-white dark:bg-gray-800 w-full rounded-md p-5 border dark:border-gray-700 bpx">
        ...
        <div class="wrapper-button w-full box-border mt-4">
          ...
          <button disabled type="button"
            ...
            <svg role="status" class="inline w-4 h-4 mr-2 text-gray-200 animate-spin dark:text-gray-600"

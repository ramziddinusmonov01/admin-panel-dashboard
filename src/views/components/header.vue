          ...
          <table class="min-w-max w-full table-auto">
            ...
            <tbody class="text-gray-600 text-sm font-light">
                ...
                <td class="py-3 px-6 text-center">
                  <div class="flex item-center justify-center">
                      ...
                      <template v-slot:body>
                        <div class="flex justify-start gap-12">
                          <div class="flex flex-col items-start gap-4">
                            <span class="font-medium text-lg flex-1">Tillar</span>
                            <div v-for="language in store.languages" :key="language.code">
                              <span class="font-normal text-base flex-1">{{ language.code }}</span>
                            </div>
                          </div>
                          <div class="flex flex-col items-start gap-4">
                    ...
                    <Modal :activeModal="activeModal" @open="changeActive" @close="closeModal" @submit="submitEdit"
                      :isImage=true title="Tahrirlash" subtitle="Cartni tahrirlash" btnTextSubmit="Saqlash">
                      <template v-slot:body>
                  ...
                  <div class="flex items-center justify-center">
                    ...
                    <Modal :activeModal="activeModal" @open="changeActive" @close="closeModal" @submit="nextModal"
                      ...
                      <template v-slot:body>
                        <div class="flex justify-start gap-12">
                          <div class="flex flex-col items-start gap-4">
                            <span class="font-medium text-lg flex-1">Joylashuv</span>
                            <div>
                              <span class="font-normal text-base flex-1">Andijon shaxar, boychechak 4</span>
                            </div>
                          </div>
                          <div class="flex flex-col items-start gap-4">
                            <span class="font-medium text-lg flex-1">Holati</span>
              ...
              <tr class="hover:bg-gray-100 dark:hover:bg-gray-500">
                ...
                <td class="py-3 px-6 text-center">
                  <button class="bg-red-200 text-red-700 py-1 px-4 rounded-full text-xs">Nofaol</button>
                </td>
                <td class="py-3 px-6 text-center">
                  <div class="flex items-center justify-center">
                    <!-- see -->
                    <Modal :activeModal="activeModal" @open="changeActive" @close="closeModal" @submit="nextModal"
                      ...
                      <template v-slot:body>
                        <div class="flex justify-start gap-12">
                          <div class="flex flex-col items-start gap-4">
                            <span class="font-medium text-lg flex-1">Ish vaqti</span>
                            <div>
                              <span class="font-normal text-base flex-1">09:00 - 22:00</span>
                            </div>
                          </div>
                          <div class="flex flex-col items-start gap-4">
                            <span class="font-medium text-lg flex-1">Holati</span>
                      ...
                      <template v-slot:body>
                        <div class="flex justify-start gap-12">
                          <div class="flex flex-col items-start gap-4">
                            ...
                            <div>
                              <span class="font-normal text-base flex-1">+99897 628 28 82</span>
                            </div>
                          </div>
                          <div class="flex flex-col items-start gap-4">
                            <span class="font-medium text-lg flex-1">Holati</span>
            ...
            <table class="min-w-max w-full table-auto">
              ...
              <tbody class="text-gray-600 text-sm font-light">
                <tr class=" hover:bg-gray-100 dark:hover:bg-gray-500">
                  <td class="py-3 px-6 text-left">
                    <div class="flex items-center">
                      <span class="text-base font-medium">Uyingiz uchun antiqa mebellar</span>
                    </div>
                  </td>
                  <td class="py-3 px-6 text-center">
                    <button class="bg-green-200 text-green-700 py-1 px-4 rounded-full text-xs">Faol</button>
                      ...
                      <Modal :activeModal="activeModal" @open="changeActive" @close="closeModal" @submit="nextModal"
                        ...
                        <template v-slot:body>
                          <div class="flex justify-start gap-12">
                            ...
                            <div class="flex flex-col items-start gap-4">
                              <span class="font-normal text-base flex-1">Uyingiz uchun antiqa mebellar</span>
                              <span class=" bg-green-200 text-green-700 py-1 px-4 rounded-full text-xs">Faol</span>
                            </div>
                          </div>
                        </template>
            ...
            <table class="min-w-max w-full table-auto">
              ...
              <tbody class="text-gray-600 text-sm font-light">
                <tr class=" hover:bg-gray-100 dark:hover:bg-gray-500">
                  <td class="py-3 px-6 text-left">
                    <div class="flex items-center">
                      <span class="text-base font-medium">Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                        Blanditiis, mollitia.</span>
                    </div>
                  </td>
                  <td class="py-3 px-6 text-center">
                    <button class="bg-green-200 text-green-700 py-1 px-4 rounded-full text-xs">Faol</button>
                      ...
                      <Modal :activeModal="activeModal" @open="changeActive" @close="closeModal" @submit="nextModal"
                        ...
                        <template v-slot:body>
                          <div class="flex justify-start gap-12">
                            ...
                            <div class="flex flex-col items-start gap-4">
                              <span class="font-normal text-base flex-1">Lorem ipsum dolor sit amet consectetur
            ...
            <table class="min-w-max w-full table-auto">
              ...
              <tbody class="text-gray-600 text-sm font-light">
                <tr class=" hover:bg-gray-100 dark:hover:bg-gray-500">
                  ...
                  <td class="py-3 px-6 text-left">
                    <div class="flex items-center">
                      <span class="text-base font-medium">Mebellar tanlovi</span>
                    </div>
                  </td>
                  <td class="py-3 px-6 text-center">
                    <button class="bg-green-200 text-green-700 py-1 px-4 rounded-full text-xs">Faol</button>
                    ...
                    <div class="flex item-center justify-center">
                      ...
                      <Modal :activeModal="activeModal" @open="changeActive" @close="closeModal" @submit="nextModal"
                        ...
                        <template v-slot:body>
                          <div class="flex justify-start gap-12">
                            <div class="flex flex-col items-start gap-4">
                              <span class="font-medium text-lg flex-1">Cart sarlavhasi</span>
                              <span class="font-medium text-lg flex-1">Cart matni</span>
                              <span class="font-medium text-lg flex-1">Holati</span>
                            </div>
                            <div class="flex flex-col items-start gap-4">
                              <span class="font-normal text-base flex-1">250+</span>
                              <span class="font-normal text-base flex-1">Mebellar tanlovi</span>
                              <span class=" bg-green-200 text-green-700 py-1 px-4 rounded-full text-xs">Faol</span>
                            </div>
                          </div>
                        </template>
            ...
            <table class="min-w-max w-full table-auto">
              ...
              <tbody class="text-gray-600 text-sm font-light">
                <tr class=" hover:bg-gray-100 dark:hover:bg-gray-500">
                  <td class="py-3 px-6 text-left">
                    <div class="flex items-center">
                      <span class="text-base font-medium">Bepul yetkazib berish</span>
                    </div>
                  </td>
                  <td class="py-3 px-6 text-left">
                    <div class="flex items-center">
                      <span class="text-base font-medium">Bizda siz istagan mebelni yetkazib berish xizmati mavjud</span>
                    </div>
                  </td>
                  <td class="py-3 px-6 text-left">
                    <div class="flex items-center">
                        ...
                        <template v-slot:body>
                          <div class="flex justify-start gap-12">
                            <div class="flex flex-col items-start gap-8">
                              <span class="font-medium text-lg flex-1">Sarlavha</span>
                              <span class="font-medium text-lg flex-1">Matn</span>
                              <span class="font-medium text-lg flex-1">Rasm</span>
                              <span class="font-medium text-lg flex-1">Holati</span>
                            </div>
                            <div class="flex flex-col items-start gap-4">
                              <span class="font-normal text-base flex-1">Bepul yetkazib berish</span>
                              <span class="font-normal text-base flex-1">Bizda siz istagan mebelni yetkazib berish xizmati
                                mavjud</span>
                              <img src="@/assets/img/truck.png" alt="icon">
                              <span class=" bg-green-200 text-green-700 py-1 px-4 rounded-full text-xs">Faol</span>
                            </div>
